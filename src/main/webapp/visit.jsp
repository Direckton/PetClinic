              ...
              <form class="" method="POST" action="${pageContext.request.contextPath}/visits">
                  <div class="row g-3 justify-content-md-center modal-body">
                      ...
                      <div class="col-auto">
                        ...
                        <input type="date" class="form-control" id="inputDate" name="inputDate" value="Cat">
                      </div>
                      <div class="col-2">
                          <label for="inputTime" class="">Time</label>
                          <input type="time" class="form-control" id="inputTime" name="inputTime" value="1">
                      </div>
                      <div class="col-2">
                          <label for="inputCost" class="">Cost</label>
                          <input type="number" class="form-control" id="inputCost" name="inputCost" value="1">
                      </div>
                  </div>
